...
def predict_patient(patient_id):
    ...
    _, listing_ids = model({
        ...
        "patient_age": np.array([55], dtype=np.int64),
        "patient_dialysis_freq": np.array([3.0], dtype=np.float32),
        "patient_dialysis_latitude": np.array([1.405], dtype=np.float32),
        "patient_dialysis_longitude": np.array([103.901], dtype=np.float32),
        "patient_skills": np.array([['translation'] * 78]),
    }) 
    ...
    scores = model({
        ...
        "patient_age": np.array([55] * len(listings), dtype=np.float32),
        "patient_dialysis_freq": np.array([3.0] * len(listings), dtype=np.float32),
        "patient_dialysis_latitude": np.array([1.405] * len(listings), dtype=np.float32),
        "patient_dialysis_longitude": np.array([103.901] * len(listings), dtype=np.float32),
        "patient_skills": np.array([['translation'] * 2] * len(listings)),

        # "listing_id": listing_ids,
        "listing_id": np.array([str(patient_id)] * len(listings)),
